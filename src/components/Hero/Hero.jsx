        ...
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 pt-6 pb-0">
              <div className="flex items-center gap-0.5 drop-shadow-[0_0_8px_rgba(168,85,247,0.45)]">
                <span className="font-display font-black italic text-sm tracking-tighter bg-gradient-to-r from-purple-400 via-pink-400 to-cyan-400 bg-clip-text text-transparent pr-1">
                  Tranzio
                </span>
