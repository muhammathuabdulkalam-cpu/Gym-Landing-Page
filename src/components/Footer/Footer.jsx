    ...
    <footer className="relative bg-background border-t border-white/5 py-16 px-6 md:px-12 overflow-hidden">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-12">
        ...
        <div className="max-w-xs flex flex-col gap-4">
          <Link to="/" className="group flex items-center gap-0.5 transition-transform duration-300 hover:scale-102 active:scale-98 w-max drop-shadow-[0_0_10px_rgba(168,85,247,0.45)]">
            <span className="font-display font-black italic text-lg tracking-tighter bg-gradient-to-r from-purple-400 via-pink-400 to-cyan-400 bg-clip-text text-transparent pr-1">
              Tranzio
            </span>
